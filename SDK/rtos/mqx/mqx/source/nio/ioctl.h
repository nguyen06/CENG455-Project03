...
#define IO_IOCTL_SERIAL_RXBUFF_GET_SIZE     0x2009
#define IO_IOCTL_SERIAL_RXBUFF_RESET        0x200A
#define IO_IOCTL_SERIAL_RXBUFF_CLR_OVERFLOW 0x200B
#define IO_IOCTL_SERIAL_RXBUFF_GET_OVERFLOW 0x200C
#define IO_IOCTL_SERIAL_TXBUFF_GET_SIZE     0x200D
#define IO_IOCTL_SERIAL_TXBUFF_GET_AVAIL    0x200E
