...
*/
#ifndef PSP_IDLE_STACK_SIZE
#define PSP_IDLE_STACK_SIZE                         (PSP_MINSTACKSIZE + 8)
#endif

/* Init task stack size
*/
#ifndef PSP_INIT_STACK_SIZE
#define PSP_INIT_STACK_SIZE                         (PSP_MINSTACKSIZE + 600) /* 600 is empirical value */
#endif
...
*/
/* FSL_FEATURE_INTERRUPT_IRQ_MAX is defined in CMSIS header included in kinetis.h. The cortex.h is included later in psp_cpu.h than kinetis.h */
#define PSP_MAXIMUM_INTERRUPT_VECTORS           FSL_FEATURE_INTERRUPT_IRQ_MAX - _PSP_VECTOR_BASE
...
#if (CORTEX_PRIOR_IMPL > __NVIC_PRIO_BITS)
#define MQX_TO_NVIC_PRIOR(x)                (x << (CORTEX_PRIOR_IMPL - __NVIC_PRIO_BITS))
#define NVIC_TO_MQX_PRIOR(x)                (x >> (CORTEX_PRIOR_IMPL - __NVIC_PRIO_BITS))
#else
#define MQX_TO_NVIC_PRIOR(x)                (x << (__NVIC_PRIO_BITS - CORTEX_PRIOR_IMPL))
#define NVIC_TO_MQX_PRIOR(x)                (x >> (__NVIC_PRIO_BITS - CORTEX_PRIOR_IMPL))
#endif
