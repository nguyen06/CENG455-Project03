...
/* Forward declaration of existing structure in MQX generic */
struct time_struct;
...
bool   _psp_ticks_to_time(PSP_TICK_STRUCT_PTR, struct time_struct *);
...
void      _psp_time_to_ticks(struct time_struct *, PSP_TICK_STRUCT_PTR);
