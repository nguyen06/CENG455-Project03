...
#error MESSAGE component is currently disabled in MQX kernel. Please set MQX_USE_MESSAGES to 1 in mqx_sdk_config.h and recompile kernel.
#endif

#if !MQXCFG_ALLOCATOR && (! defined (MQX_DISABLE_CONFIG_CHECK))
#error "Allocator functionality is currently disabled in MQX kernel. Please set MQXCFG_ALLOCATOR to some other value."
#endif
/*--------------------------------------------------------------------------*/
