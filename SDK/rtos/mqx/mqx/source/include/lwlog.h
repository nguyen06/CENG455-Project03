...
#error LWLOG component is currently disabled in MQX kernel. Please set MQX_USE_LWLOGS to 1 in mqx_sdk_config.h and recompile kernel.
#endif

#if !MQXCFG_ALLOCATOR && !MQXCFG_STATIC_LWLOG && (! defined (MQX_DISABLE_CONFIG_CHECK))
#error Cannot use dynamic lwlogs without allocators. Please set MQXCFG_ALLOCATOR to some value or use static lwlogs.
#endif
