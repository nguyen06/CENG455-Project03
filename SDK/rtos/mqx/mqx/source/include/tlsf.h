 ...
 * \brief Create/destroy a memory pool.
 */
...
/*!
 * \cond DOXYGEN_PRIVATE
 * \brief malloc/memalign/realloc/free replacements.
 */
...
/*!
 * \cond DOXYGEN_PRIVATE
 * \brief Returns internal block size, not original request size
 */
...
/*!
 * \cond DOXYGEN_PRIVATE
 * \brief Returns nonzero if any internal consistency check fails.
 */
