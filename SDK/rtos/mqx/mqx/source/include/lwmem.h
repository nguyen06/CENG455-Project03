...
#include "mqx_cnfg.h"
#if (MQXCFG_ALLOCATOR != MQX_ALLOCATOR_LWMEM) && (! defined (MQX_DISABLE_CONFIG_CHECK))
#error LWMEM component is currently disabled in MQX kernel. Please set MQXCFG_ALLOCATOR to MQX_ALLOCATOR_LWMEM in mqx_sdk_config.h and recompile kernel.
#endif
