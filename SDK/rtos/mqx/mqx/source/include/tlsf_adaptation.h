...
#include "tlsf.h"
#if (MQXCFG_ALLOCATOR != MQX_ALLOCATOR_TLSF) && (! defined (MQX_DISABLE_CONFIG_CHECK))
#error tlsf component is currently disabled in MQX kernel. Please set MQXCFG_ALLOCATOR to MQX_ALLOCATOR_TLSF in mqx_sdk_config.h and recompile kernel.
#endif
