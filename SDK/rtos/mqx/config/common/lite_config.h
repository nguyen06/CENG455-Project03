...
#ifndef __lite_config_h__
#define __lite_config_h__

/* Disable MQX_STD_TIME_API due the conflict with time.h from system library */
#ifndef MQX_STD_TIME_API
#define MQX_STD_TIME_API  0
#endif

#ifndef MQXCFG_INIT_TASK
#define MQXCFG_INIT_TASK 0
#endif
...
#define MQX_INTERRUPT_STACK_SIZE                 (1024)  /* Previously defined in bsp_config.h */
#endif

#ifndef MQXCFG_STATIC_ISR_TABLE
#define MQXCFG_STATIC_ISR_TABLE                  1
#endif
...
#define MQXCFG_PREALLOCATED_SYSTEM_STACKS        1
#endif

#ifndef MQXCFG_PREALLOCATED_READYQ
#define MQXCFG_PREALLOCATED_READYQ               1
#endif
...
#define MQXCFG_STATIC_MUTEX                      1
#endif

#ifndef MQXCFG_STATIC_LWLOG
#define MQXCFG_STATIC_LWLOG                      1
#endif

#ifndef MQXCFG_STATIC_KLOG
#define MQXCFG_STATIC_KLOG                       1
#endif
...
** then mqx will do the garbage collecting on task destroy.
*/
#ifndef MQX_ALLOCATOR_GARBAGE_COLLECTING
#define MQX_ALLOCATOR_GARBAGE_COLLECTING 0
#endif
